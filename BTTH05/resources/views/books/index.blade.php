                            ...
                            <table class="table">
                                ...
                                @foreach($books as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('books.show',$item->id) }}" title="View Book"><button class="btn btn-info btn-sm"><i class="fa-regular fa-eye"></i></button></a>
                                            <a href="{{ route('books.edit',$item->id) }}" title="Edit Book"><button class="btn btn-primary btn-sm"><i class="fa-regular fa-pen-to-square"> </i></button></a>
                                                ...
                                                <!-- Modal -->
                                                <form method="POST" action="{{ route('books.destroy',$item->id) }}" accept-charset="UTF-8" style="display:inline">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
