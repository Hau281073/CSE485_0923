<?php
    if(isset($_GET['check_account']) && $_GET['check_account']==='true'){
        header("Location: admin/index.php?check_login=true");
        exit;
    }
?>
<!DOCTYPE html>
...
<body>
    ...
    <div class="row w-100" style="position:absolute; top:120px;">
        <div class="col w-100" id="login_content">
            <div class="row vh-100" style="position: relative;">
                <div id="form-icon">
                ...
                <div id="form_login" style="position:absolute;">
                    <form action="check_account.php" method="post">
                        ...
                        <div class="input-group mb-3">
                            <span class="input-group-text" id="basic-addon1"><i class="bi
                            bi-person-fill"></i></span>
                        ...
                        <div class="text-center c-warning">
                            <hr>
                            <p>Don't have an account <a href="register.php">Log In</a></p>
