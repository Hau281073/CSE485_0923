<div class="col-md-10 offset-md-2 vw-100">
     <header class="header vw-100" style="margin-left: -25px">
     ...
     <div class="menu-right rounded-start-5 d-flex align-items-center flex-column bg-white justify-content-between">
         <div class="userLogo">
             <img src="../../imag/5_UwuAZQl.jpg" alt="" class="user">
         </div>
         ...
         <div class="languages">
             <div class="icon-Languages"><img src="../../imag/en.png"></div>
