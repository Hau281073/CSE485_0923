			...
			<div class="table-title">
				<div class="row d-flex justify-content-between">
					...
					<div class="col-sm-10">
                        ...
                        style="background: none; color: #FF6A59; border: 1px solid #FF6A59;">
                         <span>Delete</span></a>						
					</div>
				</div>
			</div>
				...
				<tbody class="body" style="font-size: 13px">
					<tr>
						...
						<td class="icon d-flex gap-1" style="border-radius:0%">
                            ...
                            <a href="#editEmployeeModal" class="edit" data-toggle="modal"><i class="fa-solid fa-pen"
                                    style="  font-size: 15px;color:#fff"></i>
                            <a href="#editEmployeeModal" class="delete" data-toggle="modal"><i class="fa-solid fa-trash"
                                    style="  font-size: 15px;color:#fff"></i>
                         </a>
                        </td>
					</tr>
